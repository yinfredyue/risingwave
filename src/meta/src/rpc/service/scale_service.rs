...
use risingwave_pb::scale_service::scale_service_server::ScaleService;
use risingwave_pb::scale_service::{PauseRequest, PauseResponse, ResumeRequest, ResumeResponse};
