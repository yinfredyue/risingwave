...
use crate::hummock::{
    ...
    LruCache, MetaCache, Sstable, SstableMeta, SstableWriter, WriteCachePolicy,
};
...
pub fn new_meta_cache(meta_cache_capacity: usize) -> MetaCache {
...
impl SstableStore {
    pub fn new(
        ...
        Self {
            ...
            meta_cache: new_meta_cache(meta_cache_capacity),
            stats,
