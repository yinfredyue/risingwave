...
pub trait StateStore: Send + Sync + 'static + Clone {
    ...
    fn sync(&self, prev_epoch: Option<u64>, last_epoch: Option<u64>,stats: Option<Arc<StateStoreMetrics>>) -> Self::SyncFuture<'_>;
    ...
    fn get_uncommitted_ssts(&self, _epoch: u64, _last_epoch: u64) -> Vec<(u64,Vec<LocalSstableInfo>)> {
        todo!()
    }
